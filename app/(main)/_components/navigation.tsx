  ...
  const resetWidth = () => {
    if (sidebarRef.current && navbarRef.current) {
      ...
      navbarRef.current.style.setProperty(
        "width",
        isMobile ? "0" : "calc(100% - 240px)" // corrected syntax here
      );
  ...
  return (
    <>
      ...
      >
        ...
        >
          <ChevronsLeftIcon className="h-6 w-6 hover:cursor-pointer" />
        </div>
        <div>
          <p>Action items</p>
        </div>
      ...
      <div
        ...
        className={cn(
          ...
          isResetting && " transition-all ease-in-out duration-300",
          isMobile && "left-0 w-full" // corrected classNames here
        )}
      >
